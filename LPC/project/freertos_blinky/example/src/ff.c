...
DWORD get_fattime (void){
	...
	aux = ((time.time[RTC_TIMETYPE_YEAR]-1980)<<25)|(time.time[RTC_TIMETYPE_MONTH]<<21)|(time.time[RTC_TIMETYPE_DAYOFMONTH]<<16)|(time.time[RTC_TIMETYPE_HOUR]<<11)|(time.time[RTC_TIMETYPE_MINUTE]<<5)|(time.time[RTC_TIMETYPE_SECOND]>>1);
