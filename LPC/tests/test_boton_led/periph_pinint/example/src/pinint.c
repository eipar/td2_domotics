...
#define GPIO_INTERRUPT_PIN_1     4	/* GPIO pin number mapped to interrupt */
#define GPIO_INTERRUPT_PIN_2     5	/* GPIO pin number mapped to interrupt */
#define GPIO_INTERRUPT_PIN_3     6	/* GPIO pin number mapped to interrupt */
#define GPIO_INTERRUPT_PIN_4     7	/* GPIO pin number mapped to interrupt */
...
void GPIO_IRQ_HANDLER(void)
{
	...
	interrupt = Chip_GPIOINT_GetStatusFalling(LPC_GPIOINT, GPIOINT_PORT2);

	if(interrupt & (1<<4)){
		Chip_GPIOINT_ClearIntStatus(LPC_GPIOINT, GPIO_INTERRUPT_PORT, 1 << GPIO_INTERRUPT_PIN_1);

		Chip_GPIO_WritePortBit(LPC_GPIO, 0, 16, TRUE);
		Chip_GPIO_WritePortBit(LPC_GPIO, 0, 23, TRUE);
	}
	if(interrupt & (1<<5)){
		Chip_GPIOINT_ClearIntStatus(LPC_GPIOINT, GPIO_INTERRUPT_PORT, 1 << GPIO_INTERRUPT_PIN_2);

		Chip_GPIO_WritePortBit(LPC_GPIO, 0, 16, FALSE);
		Chip_GPIO_WritePortBit(LPC_GPIO, 0, 23, FALSE);
	}
	if(interrupt & (1<<6)){
		Chip_GPIOINT_ClearIntStatus(LPC_GPIOINT, GPIO_INTERRUPT_PORT, 1 << GPIO_INTERRUPT_PIN_3);

		Chip_GPIO_WritePortBit(LPC_GPIO, 0, 16, TRUE);
		Chip_GPIO_WritePortBit(LPC_GPIO, 0, 23, TRUE);
	}
	if(interrupt & (1<<7)){
		Chip_GPIOINT_ClearIntStatus(LPC_GPIOINT, GPIO_INTERRUPT_PORT, 1 << GPIO_INTERRUPT_PIN_4);
...
int main(void)
{
	...
	Chip_GPIO_SetPinDIRInput(LPC_GPIO, GPIO_INTERRUPT_PORT, GPIO_INTERRUPT_PIN_1);
	Chip_GPIO_SetPinDIRInput(LPC_GPIO, GPIO_INTERRUPT_PORT, GPIO_INTERRUPT_PIN_2);
	Chip_GPIO_SetPinDIRInput(LPC_GPIO, GPIO_INTERRUPT_PORT, GPIO_INTERRUPT_PIN_3);
	Chip_GPIO_SetPinDIRInput(LPC_GPIO, GPIO_INTERRUPT_PORT, GPIO_INTERRUPT_PIN_4);
	...
	Chip_GPIOINT_SetIntFalling(LPC_GPIOINT, GPIO_INTERRUPT_PORT, (1 << GPIO_INTERRUPT_PIN_1)|(1 << GPIO_INTERRUPT_PIN_2)|(1 << GPIO_INTERRUPT_PIN_3)|((1 << GPIO_INTERRUPT_PIN_4)));
